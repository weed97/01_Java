...
public class Application2 {
    public static void main(String[] args) {
         ...
         * 초기화
         *
         * 초기화 할떄 대입 연산자 기준 오른쪽과 왼쪽은 무조건 같은 타입이어야 한다.
         * */

        bnum = 1; // 초기화
        snum = 2;
        inum = 4;
        //lnum = 8; // 아무문제 없는것 같지만 사실 뒤에 대문자 L을 붙여야 한다.형변환..
        lnum = 8L;
        ...
        isTrue = true;
        isTrue = false; // true 혹은 false 중 한가지의 값만사용 가능하다.
        ...
        // 문자
        System.out.println("ch의 값 :" + ch); // 문자형식으로 넣었던 변수 'a'
