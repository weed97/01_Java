...
public class User {
    ...
    * 생성자의 사용목적
    *
    * 1. 인스턴스 생성 시점에 수행할 명령이 있는 경우 사용된다.
...
//        this.enrollDate= enrollDate;
        ...
        /*
        * this() 사용하기
        * this() 는 동일 클래스 내에 작성한 생성자 메소드를 호출하는 구조이다.
        * 괄호 안에 매개변수의 타입, 갯수, 순서에 맞는 생성자를 호출하고 복귀한다.(메소드 동일)
        * this() 는 가장 첫 줄에 선언해야하며, 그렇지 않은경우 Compile Error가 발생한다.
        * */
        ...
        System.out.println("User의 모든 생성자를 초기화 한다.");

    }

        /*복사 생성자 -> 같은내용의 인스턴스를 만들때 사용
        * 동일한 값을가지지만 새롭게 할당되는 인스턴스이기때문에 서로다른 주소값을 가지게 된다.
        * => 깊은복사
        *  */
    public User(User otherUser) {
        ...
        System.out.println("othersUser의 hasCode : " + otherUser.hashCode());
