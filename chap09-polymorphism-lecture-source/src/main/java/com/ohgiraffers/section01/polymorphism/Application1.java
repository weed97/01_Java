...
public class Application1 {
    public static void main(String[] args) {
        ...
        * 2. 상속을 기반으로 한 기술이기 떄문에 상속관계에 있는 모든 객체는 동일한 메서지를
        *    수신 할 수 있다. 동일한 메세지를 수신하고 처리할때 객체별로 다르게 할 수 있다는
        * 장점을 가짐
        * 3. 확장성이 좋은 코드를 작성할 수 있다.
        * 4. 결합도 낮춰서 유지보수성을 증가시킬 수 있다.
        *
        * */
...
//        a2.bite();
       ...
       // ((Tiger)a1).bite();
        ...
        System.out.println("a1이 Rabiit인지 확인 : " + (a1 instanceof  Rabbit));
        // 상속받은 타입도 함꼐 가지고있다.(다형성)
...
//        Rabbit rabbit1 =  animal1; // down-casting 명시적 형변환 불가
